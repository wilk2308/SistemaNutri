...
<body id="page-top">
    ...
    <div id="wrapper">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                      <!-- <h6 class="collapse-header">Componentes Personalizados:</h6>  
                        ...
                        <h6 class="collapse-header">COBRANÇA:</h6> 
                        <?= anchor(base_url('cobrancaController/index'), 'Nova Cobrança', ['class' => 'collapse-item'])?>
                        ...
                        <?= anchor(base_url('clienteController/index'), 'Clientes', ['class' => 'collapse-item'])?>
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <h6 class="collapse-header">Lançar Movimentações:</h6> 
                                    <?= anchor(base_url('movimentacaoController/index'), 'Lançar Movimentações', ['class' => 'collapse-item'])?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Recebido</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">R$ 3.477.945,00 </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                LUCRO (ANUAL)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">R$ 2.585.050</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Pago</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">R$ 2.805.196,89</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Bocayuva Advogados 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
